...
subset<- medicaid_expansion %>% 
  filter(Date_Adopted>=as.Date("2014-08-15") | is.na(medicaid_expansion$Date_Adopted))
...
syn <- augsynth(uninsured_rate ~ treatment, State, year, subset,
progfunc = "None", scm = T) 
...
ridge_syn <- augsynth(uninsured_rate ~ treatment, State, year, subset,
