...
ppool_syn_summ$att %>%
  filter(Level %in% c("Arizona", "Arkansas",  "Colorado","Connecticut","Delaware","District of Columbia", "Hawaii", "Nebraska", "Utah"))%>%
  ...
  ggtitle('Synthetic Controls for Medicare Expansion') +
  xlab('Time') +
